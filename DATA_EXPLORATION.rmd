...
annotation_WHO_temp_severity = rowAnnotation(WHO_severity = combined_dataset_features$WHO_temp_severity,
                                             col = list(WHO_severity = c("NEGATIVE"="#ef476f", "mild"="#ffd166", "moderate"="#06d6a0", "severe"="#118ab2", "critical"="#073b4c" )))
Heatmap(protein_scaled, name="Scaled protein abundance", use_raster = FALSE, show_row_names = FALSE, show_column_names = FALSE, right_annotation = annotation_WHO_temp_severity)
```
INTERPRETATION:
