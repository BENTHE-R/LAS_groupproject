...
ggplot(confidence_intervals_df, aes(x = comparison, y = mean_diff)) +
  ...
  labs(title = "Confidence Intervals for Mean Differences",
       x = "Comparison",
       y = "Mean Difference") +
  theme_minimal() +
...
```
Coclusion:
A Kruskal-Wallis test reveals a significant difference in MX1 expression among the different covid severity groups (p-value < 2.2e-16).
